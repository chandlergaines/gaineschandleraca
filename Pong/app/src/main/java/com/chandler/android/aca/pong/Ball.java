...
public class Ball {
    ...
    public Ball(int screenX, int screenY){
        ...
        mRect = new RectF(); //RectF will represent the location of the ball
    }
    ...
    public void update(long fps){
        ...
        //the position of the left corner equals its starting
        //point plus the velocity divided by frames per second
        mRect.top = mRect.top + (mYVelocity / fps);
        //same as calculations for left
        mRect.right = mRect.left + mBallWidth;
        //the position of right equals the position of left plus width
        mRect.bottom = mRect.top - mBallHeight;
        //same as calculations for right
    }
