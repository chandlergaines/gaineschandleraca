...
public class DataManager {
  ...
  */
    ...
    public void addPhoto(Photo photo) {
        ...
        //INSERT INTO wis_table_photos (image_title, image_uri, tag1, tag2, tag3)
        // VALUES -pulled from photo class variables, correspond with table labels
        ...
        //INSERT INTO wis_table_tags (tag)
        //SELECT '(grab the tag)' WHERE NOT EXISTS (SELECT 1 FROM
        // wis_table_tags WHERE tag = '(grab the tag)';
    ...
    private class CustomSQLiteOpenHelper extends SQLiteOpenHelper {
        ...
        public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
            ...
            String addLongColumn = "ALTER TABLE " + TABLE_PHOTOS + " ADD "
                    + TABLE_ROW_LOCATION_LONG + " real;";

            db.execSQL(addLongColumn);

            String addLatColumn = "ALTER TABLE " + TABLE_PHOTOS + " ADD "
